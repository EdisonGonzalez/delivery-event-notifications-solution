...
public final class NotificationEventMapper {
  ...
  /** Converts a notification JPA entity to a domain model. */
  ...
  /** Converts a domain model to a notification JPA entity. */
  ...
  /** Converts a subscription JPA entity to a domain model. */
