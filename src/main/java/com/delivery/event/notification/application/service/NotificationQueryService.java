...
public class NotificationQueryService implements NotificationQueryUseCase {
    ...
    @Override
    public List<NotificationEvent> findAll(String clientId, DeliveryStatus status, Instant from, Instant to) {
    ...
    public NotificationEvent findById(String clientId, UUID notificationEventId) {
        return notificationRepositoryPort.findByIdAndClientId(notificationEventId, clientId)
