...
class ProcessNotificationServiceTest {
    ...
    void shouldIgnoreNotificationWithoutSubscription() {
        ...
        when(repositoryPort.findClaimableBatch(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.anyInt()))
    ...
    void shouldRetryFailedDelivery() {
        ...
        when(repositoryPort.findClaimableBatch(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.anyInt())).thenReturn(List.of(event));
